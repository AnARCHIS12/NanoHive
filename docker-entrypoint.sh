...
NH_PUBLIC_MODE="${NH_PUBLIC_MODE:-false}"
NH_GUEST_USERNAME="${NH_GUEST_USERNAME:-guest}"
NH_GUEST_PASSWORD="${NH_GUEST_PASSWORD:-}"

for var in NH_SHOW_LOGO_TEXT NH_COLORIZE_LOGO NH_SHOW_RECENT_SERIES NH_CUSTOM_SERIES_CARDS NH_SHOW_HERO_CAROUSEL NH_SHOW_RATINGS NH_PUBLIC_MODE; do
  eval "val=\$$var"
  case "$val" in
    true|false) ;;
